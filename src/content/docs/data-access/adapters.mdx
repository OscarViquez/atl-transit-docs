---
title: Adapters
description: How to use adapters to connect to different data sources
---
...
- adapters
  - stations
    - station-details-page.ts
    - station-train-page.ts
    - …
</FileTree>
...
export const getNearestStationArrivals = (
  ...
  try {
    ...
    const nearestStations = getStationByUserCoordinates(
      userLocation,
      stationInfo
    );
